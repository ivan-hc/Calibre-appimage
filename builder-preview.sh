...
DOWNLOAD_PAGE=$(curl -Ls https://download.calibre-ebook.com/preview/ | tr '">< ' '\n' | grep -i x86_64 | tail -1)
DOWNLOAD_URL="https://download.calibre-ebook.com/preview/$DOWNLOAD_PAGE"
